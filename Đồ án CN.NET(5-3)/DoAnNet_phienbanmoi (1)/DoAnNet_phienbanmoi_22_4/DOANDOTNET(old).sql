...
CREATE TABLE LichHoc (
    ...
    CaHoc NVARCHAR(50),
    MaPhong VARCHAR(10),
    MaNhanVien VARCHAR(10), -- giáo viên
...
CREATE TABLE PhanCongGiangDay (
    ...
    GhiChu NVARCHAR(250),
     FOREIGN KEY (MaNhanVien) REFERENCES NhanVien(MaNhanVien),
     FOREIGN KEY (MaLopHoc) REFERENCES LopHoc(MaLopHoc),
     UNIQUE (MaLopHoc) -- Mỗi lớp chỉ có 1 giáo viên đứng lớp
)
go


INSERT INTO CoSo (MaCoSo, TenCoSo, DiaChi, SoDienThoai, Email) VALUES
('CS05', N'Cơ sở TP.HCM', N'45 Nguyễn Huệ, TP.HCM', '0978123456', 'tphcm@englishcenternp3.com'),
('CS06', N'Cơ sở Hà Nội', N'12 Hàng Bài, Hà Nội', '0918765432', 'hanoi@englishcenternp3.com'),
('CS07', N'Cơ sở Bình Định', N'23 Trần Hưng Đạo, Bình Định', '0901234567', 'binhdinh@englishcenternp3.com'),
('CS08', N'Cơ sở Lâm Đồng', N'67 Hồ Xuân Hương, Lâm Đồng', '0938765432', 'lamdong@englishcenternp3.com'),
('CS09', N'Cơ sở Đồng Nai', N'5 Nguyễn Ái Quốc, Đồng Nai', '0945678901', 'dongnai@englishcenternp3.com');
